  ...
  return (
    <div className="w-full grid bg-gradient-to-bl from-black/[0.01] to-black/[51] relative  lg:h-screen">
      ...
      <div className="w-full relative">
        ...
        <div className=" flex lg:mx-10 lg:px-10 flex-col pt-8 md:flex-row md:justify-between md:items-center">
          <h1
            className="text-white font-['Inter'] text-center lg:font-bold 
          lg:text-[32px] text-[16px] uppercase tracking-[-1px] lg:max-w-[50%] 
          lg:mr-5 lg:text-left md:pr-4 md:text-[22px] lg:ml-10 ml-2 pl-4"
          >
            {' '}
            The most affortable place to stay in the san franciso bay area
          </h1>
          <div className="mx-auto pl-4 md:pr-4 flex flex-col items-center container">
